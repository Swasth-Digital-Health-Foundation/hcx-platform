...
class ParticipantControllerTests extends BaseSpec{
    ...
    void participant_search_not_found_scenario() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_SEARCH).content(getSearchNotFoundFilter()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
    ...
    void participant_search_success_scenario() throws Exception {
        registryServer.enqueue(new MockResponse()
                ...
                .addHeader("Content-Type", "application/json"));
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_SEARCH).content(getSearchFilter()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
    ...
    void participant_create_success_scenario() throws Exception {
        ...
        registryServer.enqueue(new MockResponse()
                ...
                .addHeader("Content-Type", "application/json"));
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_CREATE).content(getParticipantCreateBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(200, status);
    }
    ...
    void participant_create_payor_scenario() throws Exception {
        registryServer.enqueue(new MockResponse()
                ...
                .setBody("{ \"id\": \"open-saber.registry.invite\", \"ver\": \"1.0\", \"ets\": 1637227738534, \"params\": { \"resmsgid\": \"\", \"msgid\": \"bb355e26-cc12-4aeb-8295-03347c428c62\", \"err\": \"\", \"status\": \"SUCCESSFUL\", \"errmsg\": \"\" }, \"responseCode\": \"OK\", \"result\": { \"Organisation\": { \"osid\": \"1-17f02101-b560-4bc1-b3ab-2dac04668fd2\" } } }")
                .addHeader("Content-Type", "application/json"));
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_CREATE).content(getParticipantPayorBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(400, status);
    }
    ...
    void participant_create_payor_scheme_missing_scenario() throws Exception {
        registryServer.enqueue(new MockResponse()
                ...
                .setBody("{ \"id\": \"open-saber.registry.invite\", \"ver\": \"1.0\", \"ets\": 1637227738534, \"params\": { \"resmsgid\": \"\", \"msgid\": \"bb355e26-cc12-4aeb-8295-03347c428c62\", \"err\": \"\", \"status\": \"SUCCESSFUL\", \"errmsg\": \"\" }, \"responseCode\": \"OK\", \"result\": { \"Organisation\": { \"osid\": \"1-17f02101-b560-4bc1-b3ab-2dac04668fd2\" } } }")
                .addHeader("Content-Type", "application/json"));
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_CREATE).content(getParticipantPayorSchemeBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(400, status);
    }
    ...
    void participant_create_payor_scheme_not_allowed_scenario() throws Exception {
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_CREATE).content(getParticipantPayorSchemeNotAllowedBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(400, status);
    }
    ...
    void participant_create_endpoint_url_not_allowed_scenario() throws Exception {
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_CREATE).content(getParticipantUrlNotAllowedBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(400, status);
    }
    ...
    @Test
    void participant_create_invalid_participant_name_scenario() throws Exception {
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_CREATE).content("{ \"participant_name\": \"\", \"primary_mobile\": \"6300009626\", \"primary_email\": \"Apollohospital@gmail.com\", \"roles\": [ \"provider\" ], \"address\": { \"plot\": \"5-4-199\", \"street\": \"road no 12\", \"landmark\": \"Jawaharlal Nehru Road\", \"locality\": \"Nampally\", \"village\": \"Nampally\", \"district\": \"Hyderabad\", \"state\": \"Telangana\", \"pincode\": \"500805\" }, \"phone\": [ \"040-387658992\" ], \"status\": \"Created\", \"endpoint_url\": \"https://677e6fd9-57cc-466c-80f6-ae0462762872.mock.pstmn.io\", \"payment_details\": { \"account_number\": \"4707890099809809\", \"ifsc_code\": \"ICICI\" }, \"signing_cert_path\": \"urn:isbn:0-476-27557-4\", \"linked_registry_codes\": [ \"22344\" ], \"encryption_cert\": \"urn:isbn:0-4234\" }").header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        Map<String,Object> responseBody = JSONUtils.deserialize(response.getContentAsString(), Map.class);
        int status = response.getStatus();
        assertEquals(400, status);
        assertEquals(ErrorCodes.ERR_INVALID_PARTICIPANT_DETAILS.name(), getResponseErrorCode(responseBody));
        assertEquals("participant_name property cannot be null, empty or other than 'String'", getResponseErrorMessage(responseBody));
    }
    ...
    void participant_update_success_scenario() throws Exception {
        registryServer.enqueue(new MockResponse()
                ...
                .addHeader("Content-Type", "application/json"));
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_UPDATE).content(getParticipantUpdateBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(200, status);
    }
    ...
    void participant_update_endpoint_url_not_allowed_scenario() throws Exception {
        MvcResult mvcResult = mockMvc.perform(post(Constants.PARTICIPANT_UPDATE).content(getParticipantUrlNotAllowedBody()).header(HttpHeaders.AUTHORIZATION,getAuthorizationHeader()).contentType(MediaType.APPLICATION_JSON)).andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
        int status = response.getStatus();
        assertEquals(400, status);
    }
