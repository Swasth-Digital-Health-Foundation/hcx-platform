...
public class CoverageEligibilityTests extends BaseSpec {
    ...
    public void check_coverage_eligibility_success_plain_request_scenario() throws Exception {
        ...
        System.out.println("response______"+mvcResult);
        System.out.println("response______1"+mvcResult.getResponse().getContentAsString());
        MockHttpServletResponse response = mvcResult.getResponse();
        System.out.println("response______>"+response.toString());
        int status = response.getStatus();
