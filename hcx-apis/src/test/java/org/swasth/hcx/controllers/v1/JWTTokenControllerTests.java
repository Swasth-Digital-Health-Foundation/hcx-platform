...
public class JWTTokenControllerTests extends BaseSpec {
    ...
    @Test
    public void participant_generate_token_success() throws Exception {
    ...
    @Test
    public void participant_generate_invalid_token() throws Exception {
        keycloakServer.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody("{ \"access_token\": \"eyJhbGciOiJSUzI1NiJ9..VXRjzexufP-BFK1rjlzOWgXfuJTlvsnIYayqV6HQ3MAITP7e0lFD4sUsWs1GTfn9lSBLp3p0_61V_TKDjnJSXhPIzGN5bI4YwVTg0QhyIiMleHTHcWZ4qSeJ1wOWpe8EO5UcH867FfV0Vb6R16ok2H_sCdopluSlunB0rYMy4DsVOAO8JAkPfaoh2MKr9qms02_86qBmFCnp8TjJC8ZGhcfRDMt8ZYrzx2Tvb6pfAyWoXeprePDVcuSVWplHemO6A1cIdd5PQTomVSFp_CFK0I-HFL82G5kiBQ01gD2c34VyCM6CVeFtC5Ra85d7gGSuiUi_a8BaA63H-6YPoqZ4jg\", \"refresh_token\": \"eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIxYmVkOTcxNC00ZmY3LTRlMjItOGI4Mi0wODY5OWU5Yjk0NjUifQ..tadCV6yLUi38tbSB5sQVcjvCy6LiZ5XzE7k9L6Atr6w\", \"refresh_expires_in\": \"600\", \"not-before-policy\": \"1607576887\" , \"scope\": \"profile email\", \"token_type\": \"Bearer\", \"session_state\": \"0c66ca80-5c98-4b62-aa6b-436605e73e81\", \"expires_in\":  \"2592000\" }"));
        registryServer.enqueue(new MockResponse()
    ...
    @Test
    public void user_generate_token_success() throws Exception {
        keycloakServer.enqueue(new MockResponse()
                .setResponseCode(200)
    ...
    @Test
    public void user_generate_token_invalid() throws Exception {
        keycloakServer.enqueue(new MockResponse()
                .setResponseCode(200)
                .setBody("{ \"access_token\": \"eyJhbGciOiJSUzI1NiJ9..n9qA_yQH4FSGODEIh14VPh40ISw6aBH_wilYu2-RGjxYjpMHq4fqo3V7KN1vSy-bQaMwdO5t5c5CR03kGtBj3vMzhWvktLZS-wrkf-yqoMrwx8c-YSGfGf7kHg_tp1JrU1inl2JVjQgqhPE3YX7y_boTaBkYUQkidtxbLk_RMszs8WNR_uVrh41mNwTMZb45cPNN2nGq8d2tUtXFcBtSlVgA1gSQX56m_xOutRznlFtgDqQNHSBtdV9wZ0QdEUhIjGsBoNufkP5Ai6lyyqsRwPSMLqO3wzxa_u1HRdwneQB20BInUkCzQOGdwYAB5-3O76rdadJRFFjVBckK5aeDvw\", \"refresh_token\": \"eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJmMDM4NGRhMy05OTIwLTRmOTgtOWFlYi04MGJjZjIyZjgyNjUifQ..tYqVWa51byEMIuEbM1QlvdQjlCtXVPaayueL4ikCwN8\", \"refresh_expires_in\": \"36000\", \"not-before-policy\": \"0\" , \"scope\": \"email profile\", \"token_type\": \"Bearer\", \"session_state\": \"e0f07f15-f040-48e3-966f-50731065ca72\", \"expires_in\":  \"36000\" }"));
        registryServer.enqueue(new MockResponse()
