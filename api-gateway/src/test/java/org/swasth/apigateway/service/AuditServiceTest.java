...
class AuditServiceTest{
    ...
    void check_audit_event_generation() throws Exception {
        ...
        assertEquals(Constants.COVERAGE_ELIGIBILITY_CHECK, result.get(Constants.ACTION));
    }
