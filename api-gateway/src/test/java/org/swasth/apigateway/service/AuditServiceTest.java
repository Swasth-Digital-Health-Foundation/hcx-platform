...
class AuditServiceTest{
    ...
    void check_audit_event_generation() throws Exception {
        BaseRequest request = new BaseRequest(getRequestBody(), false, "/v1/coverageeligibility/check", "1-d2d56996-1b77-4abb-b9e9-0e6e7343c72e", "HIE/HIO.HCX");
        Map<String,Object> result = auditService.createAuditEvent(request);
