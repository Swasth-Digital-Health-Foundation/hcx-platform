...
public enum ErrorCodes {
    ...
    ERR_INVALID_NOTIFICATION_HEADERS,
    ERR_INVALID_SIGNATURE,
    ERR_INVALID_NOTIFICATION_RECIPIENT_TYPE,
    ERR_INVALID_ALGORITHM,
    ERR_INVALID_NOTIFICATION_TIMESTAMP,
    ERR_INVALID_NOTIFICATION_EXPIRY,
    ERR_INVALID_NOTIFICATION_MESSAGE,
    ERR_INVALID_NOTIFICATION_RECIPIENTS
}
