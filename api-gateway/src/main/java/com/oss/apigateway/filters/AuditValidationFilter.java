    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            try {
                ...
                protectedMap = JSONUtils.deserialize(cachedBody.toString(), HashMap.class);
                ...
                if (!participant.isEmpty()) {
                    String roles = (String) participant.get("roles");
                    String code = (String) participant.get("participantCode");
                    Map<String, String> filters = (Map<String, String>) protectedMap.get("filters");
                    filters.put("sender_code", code);
                    System.out.println("filters updated" + filters);
                    protectedMap.put("filters", filters);
                    System.out.println("protectedmap updated" + protectedMap);
                } else {
            ...
            ModifyRequestBodyGatewayFilterFactory.Config modifyRequestConfig = new ModifyRequestBodyGatewayFilterFactory.Config()
                    ...
                    .setRewriteFunction(String.class, Map.class, (exchange1, cachedBody) -> Mono.just(protectedMap));
