    ...
    <div className="h-screen bg-gray-100">
      ...
      */}
      ...
      <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
          <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
            <div className="flex flex-shrink-0 items-center px-4">
              <img className="h-12 w-auto" src={logo} alt="Swasth Alliance" />
            </div>
      ...
      <div className="h-full flex flex-1 flex-col md:pl-64">
        <div className="sticky flex items-center top-0 z-10 bg-gray-100 pl-1 pt-1 sm:pl-3 sm:pt-3 md:hidden">
          <button
            type="button"
