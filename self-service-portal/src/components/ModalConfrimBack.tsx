...
const ModalConfirmBack: React.FC<ModalProps> = ({show ,title, body, onCancelClick, onSubmitClick}:ModalProps) => {
        ...
        >
          ...
          <div className="-mx-3 flex flex-wrap gap-y-4">
            <div className="w-full px-3 2xsm:w-1/2">
              <button
                onClick={() => {setModalOpen(false), onCancelClick()}}
            ...
            <div className="w-full px-3 2xsm:w-1/2">
              ...
              onClick={() => {setModalOpen(false), onSubmitClick()}}>
                Confirm
              </button>
            </div>
          </div>
