...
object Constants {
  ...
  val PRE_AUTH_SUBMIT = "/preauth/submit"
  val PRE_AUTH_ONSUBMIT = "/preauth/on_submit"
  val COVERAGE_ELIGIBILITY_CHECK = "/coverageeligibility/check"
  val COVERAGE_ELIGIBILITY_ONCHECK = "/coverageeligibility/on_check"
  val NOTIFICATION_SUBSCRIPTION_UPDATE = "/notification/subscription/update"
  val NOTIFICATION_NOTIFY = "/notification/notify"
  val PAYMENT_NOTICE_REQUEST = "/paymentnotice/request"
  ...
  val EOB_ON_FETCH = "/eob/on_fetch"
  val REQUEST_RETRY = "/request/retry/"
  val HCX_STATUS_CONTROLLER = "/hcx/status"
  val HCX_ONSTATUS_CONTROLLER = "/hcx/on_status"
