...
object Constants {
  ...
  val NOTIFICATION_ID = "x-hcx-notification_id"
  val NOTIFICATION_DATA = "x-hcx-notification_data"
  val NOTIFICATION_TITLE = "x-hcx-notification_title"
  val NOTIFICATION_DESC = "x-hcx-notification_desc"
