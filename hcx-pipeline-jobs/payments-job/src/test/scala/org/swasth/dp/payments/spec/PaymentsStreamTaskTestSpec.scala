...
class PaymentsStreamTaskTestSpec extends BaseTestSpec {
  ...
  override protected def beforeAll(): Unit = {
    ...
    EmbeddedPostgres.builder.setPort(eligibilityCheckConfig.postgresPort).start() // Use the same port 5430 which is defined in the base-payments-test.conf
    // Clear the metrics
  ...
  "PaymentsJob" should "validate the success flow" in {
