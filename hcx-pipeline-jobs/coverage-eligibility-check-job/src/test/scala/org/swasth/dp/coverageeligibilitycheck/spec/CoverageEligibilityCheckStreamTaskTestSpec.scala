...
class CoverageEligibilityCheckStreamTaskTestSpec extends BaseTestSpec {
  ...
  override protected def beforeAll(): Unit = {
    ...
    EmbeddedPostgres.builder.setPort(eligibilityCheckConfig.postgresPort).start() // Use the same port 5430 which is defined in the base-test.conf
    // Clear the metrics
...
class EligibilityCheckEventSource extends SourceFunction[util.Map[String, AnyRef]] {

  override def run(ctx: SourceContext[util.Map[String, AnyRef]]) {
    val gson = new Gson()
    val event = """{"ets":1637320447257,"headers":{"jose":{"alg":"RSA-OAEP","enc":"A256GCM"},"protocol":{"x-hcx-recipient_code":"67890","x-hcx-request_id":"26b1060c-1e83-4600-9612-ea31e0ca5091","x-hcx-timestamp":"2021-10-27T20:35:52.636+0530","x-hcx-sender_code":"12345","x-hcx-correlation_id":"5e934f90-111d-4f0b-b016-c22d820674e1","x-hcx-status":"request.initiate"},"domain":{"request_amount":120000}},"ctx":{"sender":{"participant_code":"12345","signing_cert_path":"","roles":"admin","encryption_cert":"","endpoint_url":"","participant_name":"Test Provider","hfr_code":"0001","status":"Created"},"recipient":{"participant_code":"123456","signing_cert_path":"urn:isbn:0-476-27557-4","roles":"admin","encryption_cert":"urn:isbn:0-4234","endpoint_url":"https://httpbin.org/post","participant_name":"Test Provider","hfr_code":"0001","status":"Created"}},"mid":"761dfc11-1870-4981-b33d-16254a104a9d","action":"coverageeligibility.check","logDetails":{"code":"bad.input","message":"Provider code not found","trace":""},"status":"Submitted"}"""
...
class AuditEventsSink extends SinkFunction[util.Map[String, AnyRef]] {
