...
public class PredeterminationStreamTask {
	...
	void process(BaseJobConfig baseJobConfig) throws Exception {
		...
		SingleOutputStreamOperator<Map<String,Object>> enrichedStream = env.fromSource(kafkaConsumer, WatermarkStrategy.noWatermarks(), config.predeterminationConsumer)
