...
<div>
  ...
  <ul>
    ...
    <li><strong>Time:</strong> [Start Time] to [End Time] (timezone)</li>
    <li><strong>Duration:</strong> [Duration of Downtime]</li>
  </ul>

  <p>We apologize for any inconvenience this may cause and appreciate your patience and understanding as we work to improve Open HCX for you.</p>

  <p>Thank you for your cooperation and continued support of Open HCX.</p>

  <p>Best regards,<br>
  Open HCX support Team</p>
