...
public class JWTUtilsTest {
    ...
    public void generateAuthTokenTest() throws Exception {
        ...
        assertTrue(jwtUtils.isValidSignature(token,"https://raw.githubusercontent.com/Swasth-Digital-Health-Foundation/hcx-platform/main/hcx-apis/src/test/resources/examples/test-keys/private-key.pem"));
    }
}
