...
public class ResponseMessage {
    ...
    public static final String DEBUG_FLAG_ERR = "Debug flag cannot be null, empty and other than 'public static final String'";
    ...
    public static final String STATUS_ERR = "Status cannot be null, empty and other than 'public static final String'";
    ...
    public static final String SENDER_CODE_ERR_MSG = "Sender code cannot be null, empty and other than 'public static final String'";
    public static final String RECIPIENT_CODE_ERR_MSG = "Recipient code cannot be null, empty and other than 'public static final String'";
    public static final String TIMESTAMP_INVALID_MSG = "Invalid timestamp";
    public static final String INVALID_WORKFLOW_ID_ERR_MSG = "Workflow id cannot be null, empty and other than 'public static final String'";
    public static final String INVALID_CORRELATION_ID_ERR_MSG = "Correlation id cannot be null, empty and other than 'public static final String'";
    public static final String INVALID_API_CALL_ID_ERR_MSG = "Api call id cannot be null, empty and other than 'public static final String'";
    ...
    public static final String NOTIFICATION_TOPIC_ERR = "Notification topic code cannot be null, empty and other than 'public static final String'";
